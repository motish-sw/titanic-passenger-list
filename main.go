...
func main() {
	...
	PassengerCtrl := &controller.Passenger{}
	PassengerListCtrl := &controller.PassengerList{}

	// api endpoints
	g := server.Echo.Group("/api")
	g.GET("/Passengers/", PassengerListCtrl.GetPassengers)
	g.GET("/Passengers/:id", PassengerCtrl.GetPassengerJSON)
